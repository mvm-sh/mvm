...
var wordShapes = []wordShape{
	// Corpus-wide iface-shape harvest (2026-07-02, MVM_IFACESHAPES): the word
	// keys interface method sets demand, so reflect.Implements holds for every
	// containerElemSynthSafe interface. Sizes from measured attach demand.
	{Params: "", Results: "iii", Size: 64},
	{Params: "", Results: "piipii", Size: 1024},
	{Params: "", Results: "ppippi", Size: 128},
	{Params: "", Results: "ppp"},
	{Params: "i", Results: "iipp", Size: 64},
	{Params: "i", Results: "p", Size: 64},
	{Params: "i", Results: "pii", Size: 64},
	{Params: "i", Results: "pppp", Size: 64},
	{Params: "ii", Results: "f", Size: 128},
	{Params: "ipii", Results: "ipp", Size: 64},
	{Params: "ipii", Results: "pp", Size: 64},
	{Params: "p", Results: "pipp", Size: 64},
	{Params: "pfpii", Results: "", Size: 64},
	{Params: "pi", Results: ""},
	{Params: "pi", Results: "ipii", Size: 128},
	{Params: "pi", Results: "p", Size: 64},
	{Params: "pi", Results: "ppi", Size: 64},
	{Params: "pii", Results: "iip", Size: 64},
	{Params: "pii", Results: "p", Size: 128},
	{Params: "pii", Results: "pii"},
	{Params: "pii", Results: "ppi", Size: 64},
	{Params: "piii", Results: "", Size: 128},
	{Params: "piii", Results: "ipp", Size: 128},
	{Params: "piipii", Results: "pii", Size: 512},
	{Params: "piipii", Results: "pp", Size: 64},
	{Params: "piipiii", Results: "iipp"},
	{Params: "piipp", Results: "", Size: 64},
	{Params: "piipppii", Results: "pp", Size: 64},
	{Params: "pip", Results: "ppppi", Size: 64},
	{Params: "pipi", Results: "", Size: 64},
	{Params: "pipii", Results: ""},
	{Params: "pipp", Results: "", Size: 64},
	{Params: "pipp", Results: "pppppp", Size: 64},
	{Params: "pp", Results: "f", Size: 64},
	{Params: "pp", Results: "ppp", Size: 64},
	{Params: "pp", Results: "pppp", Size: 64},
	{Params: "ppi", Results: "", Size: 64},
	{Params: "ppi", Results: "f", Size: 64},
	{Params: "ppipii", Results: "", Size: 64},
	{Params: "pppii", Results: "p", Size: 128},
	{Params: "pppii", Results: "pp", Size: 64},
	{Params: "pppii", Results: "ppp", Size: 64},
	{Params: "pppipii", Results: "", Size: 64},
	{Params: "pppp", Results: "", Size: 64},
	{Params: "pppp", Results: "ppi", Size: 64},
	{Params: "ppppp", Results: "", Size: 64},
	{Params: "pppppii", Results: "i", Size: 128},
	{Params: "pppppippi", Results: "pp", Size: 64},
	{Params: "pppppp", Results: "", Size: 512},
	{Params: "pppppp", Results: "i", Size: 64},
	{Params: "pppppp", Results: "pp", Size: 64},
	{Params: "pppppp", Results: "ppi", Size: 64},
...
// stubSpec captures everything needed to emit one stub function and its PC-table fill.
...
// sizeRow is one shape's pool size, emitted into sizes.go.
type sizeRow struct {
	id   string
	full int
}
...
func main() {
	for _, f := range mustGlob("pool_ext_*.go") { // stale files from the old wasm-split scheme
		mustRemove(f)
	}
	for _, f := range []string{"sizes_regabi.go", "sizes_wasm.go"} {
...
func mustRemove(f string) {
	if err := os.Remove(f); err != nil {
		log.Fatalf("remove %s: %v", f, err)
	}
}
...
// emitSizes writes the poolSize<id> constants (one untagged file). The hand-written
// registry_s*.go size their slot arrays on these on every arch; the !wasm pool
// files and the wasm arrays_wasm.go both size stubs<id> on them too.
func emitSizes() {
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by gen_pools.go; DO NOT EDIT.\n")
	fmt.Fprintf(&b, "// Per-shape stub-pool sizes, tuned for the compat matrix's heaviest\n")
	fmt.Fprintf(&b, "// single-process attach counts.\n\n")
...
func emitArraysWasm() {
	...
	fmt.Fprintf(&b, "// Code generated by gen_pools.go; DO NOT EDIT.\n")
	fmt.Fprintf(&b, "// Empty stub-PC arrays so registry_s*.go compile on wasm; see gen_pools.go.\n\n")
	fmt.Fprintf(&b, "package stubs\n\nvar (\n")
	for _, s := range shapes {
		fmt.Fprintf(&b, "\tstubs%s [poolSize%s]uintptr\n", s.ID, s.ID)
	}
	fmt.Fprintf(&b, ")\n")
	writeFormatted("arrays_wasm.go", &b)
}
...
func emitWord(w wordShape) {
	...
	fmt.Fprintf(&b, "//go:build !wasm\n\n")
	fmt.Fprintf(&b, "// Code generated by gen_pools.go; DO NOT EDIT.\n")
	fmt.Fprintf(&b, "// Word-shape %s pool: %d slots. Native only (see gen_pools.go).\n\n", w.key(), sz)
	fmt.Fprintf(&b, "package stubs\n\n")
	...
	sizeRows = append(sizeRows, sizeRow{id, sz})
}
...
func emit(s shape) {
	...
	fmt.Fprintf(&b, "//go:build !wasm\n\n")
	fmt.Fprintf(&b, "// Code generated by gen_pools.go; DO NOT EDIT.\n")
	fmt.Fprintf(&b, "// Shape %s pool: %d slots. Native only (see gen_pools.go).\n\n", s.ID, sz)
	fmt.Fprintf(&b, "package stubs\n\n")
	fmt.Fprintf(&b, "import (\n\t\"unsafe\"\n")
	...
	sizeRows = append(sizeRows, sizeRow{s.ID, sz})
}
