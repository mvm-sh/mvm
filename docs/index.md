...
- [ADR-023: Index-based method dispatch](decisions/ADR-023-index-based-method-dispatch.md) (accepted; phase 1 native tables + 2' fused method frame landed, embedding/direct phases already realized, 4 deferred)
