...
func namedIface(name string) *Type {
	return &Type{
		...
		Name:         name,
		PkgName:      "google.golang.org/protobuf/reflect/protoreflect",
...
func TestCompatibleTypeErasedInterface(t *testing.T) {
	...
	structT := &Type{kind: reflect.Struct, Name: "S", PkgName: "p", Rtype: reflect.TypeFor[struct{ A int }]()}
...
func TestCompatibleTypeCrossUniverseDup(t *testing.T) {
	...
	methods := func(structRt, funcRt reflect.Type) *Type {
		return &Type{
			kind:    reflect.Struct,
			Name:    "Methods",
			PkgName: "google.golang.org/protobuf/runtime/protoiface",
			Rtype:   structRt,
	...
	c := &Type{kind: reflect.Struct, Name: "Methods", PkgName: "google.golang.org/protobuf/runtime/protoiface",
...
func TestCompatibleTypeNegatives(t *testing.T) {
	...
	reader := &Type{kind: reflect.Interface, Name: "Reader", PkgName: "io", Rtype: reflect.TypeFor[interface{ r() }]()}
	writer := &Type{kind: reflect.Interface, Name: "Writer", PkgName: "io", Rtype: reflect.TypeFor[interface{ w() }]()}
